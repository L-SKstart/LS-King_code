...
### Skill 文件体系
- **Copilot侧**：`.github/copilot-instructions.md` + `.github/skills/`下4个SKILL.md
  - `deploy-check`—7步巡检 / `diagnose`—6步诊断 / `op-log`—操作记录 / `chat-archive`—归档
- **Reasonix侧**：8个全局skill+2个项目专属（索引：`skills/SKILLS_INDEX.md`）
